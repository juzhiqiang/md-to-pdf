        ...
        >
            ...
            >
                ...
                <div class={`relative mb-8 transition-transform duration-500 ${isDragging() ? 'rotate-[-6deg] scale-110' : ''}`}>
                    <svg class="w-40 h-40 drop-shadow-2xl" viewBox="0 0 100 130" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <defs>
