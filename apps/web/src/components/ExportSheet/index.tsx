...
export function ExportSheet(props: ExportSheetProps) {
    ...
    return (
        <Show when={props.isOpen}>
            <div class="fixed inset-0 z-50 flex items-center justify-center pointer-events-none no-print">
                <style>{`
                    @keyframes es-shake {
                ...
                >
                    ...
                    <div class="w-full  !px-[10px] !py-[5px]  bg-white rounded-2xl p-3.5 flex items-center">
                        <div class="w-11 !mr-[10px] h-11 bg-[#ffebee] rounded-xl flex items-center justify-center shrink-0">
                            <svg class="w-5 h-5 text-[#ef5350]" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div class="w-full   !px-[10px] !py-[5px]  bg-white rounded-2xl overflow-hidden">
                            ...
                            >
                                <div class="w-8 h-8 bg-[#eef0ff] rounded-lg flex items-center justify-center shrink-0">
                                    <svg class="w-[14px] h-[14px] text-[#5856d6]" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                            ...
                            <div class="flex items-center h-[52px] px-4">
                                <div class="w-8 h-8 bg-[#f2f2f7] rounded-lg flex items-center justify-center shrink-0">
                                    <svg class="w-[14px] h-[14px] text-[#8e8e93]" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                        ...
                        >
                            <Show when={exportDone()} fallback={
                                <Show when={isExporting()} fallback={
                                    <>
                                        <svg class="w-[17px] h-[17px]" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" />
                                        </svg>
                                        确认导出
                                    </>
                                }>
                                    <svg class="animate-spin h-[17px] w-[17px] text-white" fill="none" viewBox="0 0 24 24">
